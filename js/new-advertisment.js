...
import NewAdvertismentFormController from './controllers/NewAdvertismentFormController.js';
...
window.addEventListener('DOMContentLoaded', async (event) => {
  ...
  // New Advertisment Controller
  const formElement = document.querySelector('form');
  new NewAdvertismentFormController(formElement);
});
